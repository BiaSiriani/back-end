...
const promptSync =require('prompt-sync');const prompt=promptSync();//{maneira dificil}
function soma(a,b){
    return a + b;
}
...
while(true){
    let escolha =prompt("Escolha a operação:1. Soma,2. Subtração,3. Multiplicação,4. Divisao,5. Exit")
